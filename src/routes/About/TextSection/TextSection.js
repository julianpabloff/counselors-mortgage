...
import AboutHeading from '../AboutHeading/AboutHeading.js';
...
function TextSection() {
    return (
        <section className="about-text">
            <div>
                <AboutHeading side="left">Who We Are</AboutHeading>
            ...
            <div>
                <AboutHeading side="right">What We Do</AboutHeading>
                <div className="max-w-container">
            ...
            <div>
                <AboutHeading side="left">Our Clients</AboutHeading>
                <div className="max-w-container">
